...
class Operador:
    def __init__(self, maxiconsumo_sess_id, andina_sess_id, oscar_david_sess_id, la_serenisima_sess_id,bees_sess_id,nombre_excel, ruta):
        ...
        self.valuador_bees = Valuador_Bees(bees_sess_id)
    ...
    def actualizar_precios(self, progress, nuevonombre, progresswindow, currentarticle):
        ...
        self.contador = 0
        self.maxiconsumo, self.andina, self.oscar_david, self.la_serenisima, self.bees, self.nodata = self.scanner.separar_por_proveedor()
        ...
        self.bees = self.scanner.intercode_bees(self.bees)
        ...
        self.bees = self.valuador_bees.get_prices(self.bees, progress, self.valuador_serenisima.contador, currentarticle)
        self.scanner.actualizar_precios(self.maxiconsumo, self.andina, self.oscar_david, self.la_serenisima, self.bees)
