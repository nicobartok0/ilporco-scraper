...
def boton():
    ...
    global operador
    operador = Operador(maxiconsumo_sess_id=str(maxi_id_label.get()), andina_sess_id=str(andina_id_label.get()), oscar_david_sess_id=str(od_id_label.get()), la_serenisima_sess_id=str(serenisima_id_label.get()), bees_sess_id=str(bees_id_label.get()), nombre_excel=str(nombre_label.get()), ruta=ruta.get())
...
def ventana_sesiones():
    ...
    ttk.Entry(sessionwindow, textvariable=bees_user).grid(column=1, row=8, pady=10)
    ttk.Entry(sessionwindow, textvariable=bees_pswd, show='*').grid(column=1, row=9, pady=10)
...
def sesionar(sessionwindow):
    ...
    bees_sess_id = sesionador.sesionar_bees(user=bees_user.get(), pswd=bees_pswd.get())
    ...
    bees_id_label.set(bees_sess_id)
