        ...
        for articulo in self.articulos:
            ...
            # BÚSQUEDA DE PRECIOS EN ANDINA
                ...
                if articulo.cod_externo != '':    
                    ...
                    response = requests.post('https://andinapedidos.com.ar/includes/buscador.php', cookies=sesion_actual.cookies, headers=sesion_actual.headers, data=sesion_actual.data)
                    soup = BeautifulSoup(response.content, 'html.parser')
                    precio = soup.find('h5')
                    if precio != None:
